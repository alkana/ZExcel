...
class CodePageTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testCodePageNumberToName()
    {
        ...
        $result = call_user_func_array(array('\ZExcel\Shared_CodePage','NumberToName'), $args);
    ...
    public function testNumberToNameWithInvalidCodePage()
    {
        ...
        try {
            $result = call_user_func(array('\ZExcel\Shared_CodePage','NumberToName'), $invalidCodePage);
        } catch (Exception $e) {
    ...
    public function testNumberToNameWithUnsupportedCodePage()
    {
        ...
        try {
            $result = call_user_func(array('\ZExcel\Shared_CodePage','NumberToName'), $unsupportedCodePage);
        } catch (Exception $e) {
