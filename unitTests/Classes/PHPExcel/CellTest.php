...
class CellTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testColumnIndexFromString()
    {
        ...
        $result = call_user_func_array(array('\ZExcel\Cell','columnIndexFromString'), $args);
    ...
    public function testColumnIndexFromStringTooLong()
    {
        $cellAddress = 'ABCD';
        try {
            $result = call_user_func(array('\ZExcel\Cell','columnIndexFromString'), $cellAddress);
    ...
    public function testStringFromColumnIndex()
    {
        $args = func_get_args();
        $expectedResult = array_pop($args);
        $result = call_user_func_array(array('\ZExcel\Cell','stringFromColumnIndex'), $args);
        $this->assertEquals($expectedResult, $result);
    }
    ...
    public function testCoordinateFromString()
    {
        $args = func_get_args();
        $expectedResult = array_pop($args);
        $result = call_user_func_array(array('\ZExcel\Cell','coordinateFromString'), $args);
        $this->assertEquals($expectedResult, $result);
    }
    ...
    public function testCoordinateFromStringWithRangeAddress()
    {
        ...
        try {
            $result = call_user_func(array('\ZExcel\Cell','coordinateFromString'), $cellAddress);
        } catch (\ZExcel\Exception $e) {
    ...
    public function testAbsoluteCoordinateFromString()
    {
        $args = func_get_args();
        $expectedResult = array_pop($args);
        $result = call_user_func_array(array('\ZExcel\Cell','absoluteCoordinate'), $args);
        $this->assertEquals($expectedResult, $result);
    }
    ...
    public function testAbsoluteCoordinateFromStringWithRangeAddress()
    {
        $cellAddress = 'A1:AI2012';
        try {
            $result = call_user_func(array('\ZExcel\Cell','absoluteCoordinate'), $cellAddress);
        } catch (\ZExcel\Exception $e) {
            $this->assertEquals($e->getMessage(), 'Cell coordinate string can not be a range of cells');
            return;
        }
    ...
    public function testAbsoluteReferenceFromString()
    {
        $args = func_get_args();
        $expectedResult = array_pop($args);
        $result = call_user_func_array(array('\ZExcel\Cell','absoluteReference'), $args);
        $this->assertEquals($expectedResult, $result);
    }
    ...
    public function testAbsoluteReferenceFromStringWithRangeAddress()
    {
        $cellAddress = 'A1:AI2012';
        try {
            $result = call_user_func(array('\ZExcel\Cell','absoluteReference'), $cellAddress);
        } catch (\ZExcel\Exception $e) {
            $this->assertEquals($e->getMessage(), 'Cell coordinate string can not be a range of cells');
            return;
        }
    ...
    public function testSplitRange()
    {
        $args = func_get_args();
        $expectedResult = array_pop($args);
        $result = call_user_func_array(array('\ZExcel\Cell','splitRange'), $args);
    ...
    public function testBuildRange()
    {
        $args = func_get_args();
        $expectedResult = array_pop($args);
        $result = call_user_func_array(array('\ZExcel\Cell','buildRange'), $args);
        $this->assertEquals($expectedResult, $result);
    }
    ...
    public function testBuildRangeInvalid()
    {
        $cellRange = '';
        try {
            $result = call_user_func(array('\ZExcel\Cell','buildRange'), $cellRange);
        } catch (\ZExcel\Exception $e) {
    ...
    public function testRangeBoundaries()
    {
        $args = func_get_args();
        $expectedResult = array_pop($args);
        $result = call_user_func_array(array('\ZExcel\Cell','rangeBoundaries'), $args);
        $this->assertEquals($expectedResult, $result);
    }
    ...
    public function testRangeDimension()
    {
        $args = func_get_args();
        $expectedResult = array_pop($args);
        $result = call_user_func_array(array('\ZExcel\Cell','rangeDimension'), $args);
        $this->assertEquals($expectedResult, $result);
    }
    ...
    public function testGetRangeBoundaries()
    {
        $args = func_get_args();
        $expectedResult = array_pop($args);
        $result = call_user_func_array(array('\ZExcel\Cell','getRangeBoundaries'), $args);
        $this->assertEquals($expectedResult, $result);
    }
    ...
    public function testExtractAllCellReferencesInRange()
    {
        $args = func_get_args();
        $expectedResult = array_pop($args);
        $result = call_user_func_array(array('\ZExcel\Cell','extractAllCellReferencesInRange'), $args);
        $this->assertEquals($expectedResult, $result);
    }
