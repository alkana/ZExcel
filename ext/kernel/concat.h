...
#define ZEPHIR_CONCAT_SSVV(result, op1, op2, op3, op4) \
	 zephir_concat_ssvv(&result, op1, sizeof(op1)-1, op2, sizeof(op2)-1, op3, op4, 0 TSRMLS_CC);
#define ZEPHIR_SCONCAT_SSVV(result, op1, op2, op3, op4) \
	 zephir_concat_ssvv(&result, op1, sizeof(op1)-1, op2, sizeof(op2)-1, op3, op4, 1 TSRMLS_CC);
...
#define ZEPHIR_CONCAT_VVSVSV(result, op1, op2, op3, op4, op5, op6) \
	 zephir_concat_vvsvsv(&result, op1, op2, op3, sizeof(op3)-1, op4, op5, sizeof(op5)-1, op6, 0 TSRMLS_CC);
#define ZEPHIR_SCONCAT_VVSVSV(result, op1, op2, op3, op4, op5, op6) \
	 zephir_concat_vvsvsv(&result, op1, op2, op3, sizeof(op3)-1, op4, op5, sizeof(op5)-1, op6, 1 TSRMLS_CC);
