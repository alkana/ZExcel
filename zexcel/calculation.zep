...
class Calculation
{
    ...
    {
        if (self::_localeFunctions == null) {
            let self::_localeFunctions = [];
        }
    
        if (self::_binaryOperators == null) {
            let self::_binaryOperators = [
                "+": true, "-": true, "*": true, "/": true,
                "^": true, "&": true, ">": true, "<": true,
                "=": true, ">=": true, "<=": true, "<>": true,
                "|": true, ":": true
        ...
        if (self::_localeBoolean == null) {
            let self::_localeBoolean = [
                "TRUE": "TRUE",
                "FALSE": "FALSE",
                "NULL": "NULL"
            ];
        ...
        if (self::_controlFunctions == null) {
            let self::_controlFunctions = [
                "MKMATRIX": [
                    "argumentCount": "*",
        ...
        if (self::_ExcelConstants == null) {
            let self::_ExcelConstants = [
                "TRUE": true,
                "FALSE": false,
                "NULL": null
            ];
        ...
        if (self::_PHPExcelFunctions == null) {
            let self::_PHPExcelFunctions = [
                "ABS": [
                ...
                "FALSE": [
                    "category": \ZExcel\Calculation\Functio::CATEGORY_LOGICAL,
                    "functionCall": "\\ZExcel\\Calculation\\Logical::FALSE",
                    "argumentCount": "0"
                ],
                "FDIST": [
                    "category": \ZExcel\Calculation\Functio::CATEGORY_STATISTICAL,
                ...
                "TRUE": [
                    "category": \ZExcel\Calculation\Functio::CATEGORY_LOGICAL,
                    "functionCall": "\\ZExcel\\Calculation\\Logical::TRUE",
                    "argumentCount": "0"
                ],
                "TRUNC": [
                    "category": \ZExcel\Calculation\Functio::CATEGORY_MATH_AND_TRIG,
    ...
    public function calculateCellValue(<\ZExcel\Cell> pCell = null, resetLog = null)
    {
        ...
        if (resetLog) {
            ...
            let this->_cyclicFormulaCount = 1;
        ...
        try {
            ...
            let cellAddress = array_pop(this->_cellStack);
    ...
    public static function _localeFunc(functon)
    {
        ...
        if (self::_localeLanguage !== "en_us") {
            ...
            if (isset(self::_localeFunctions[functionName])) {
                ...
                let functon = self::_localeFunctions[functionName];
    ...
    protected function _raiseFormulaError(string errorMessage)
    {
    ...
    private function _parseFormula(formula, <\ZExcel\Cell> pCell = null)
    {
        throw new \Exception("Not implemented yet!");
    }
    ...
    private function _showValue(value)
    {
        ...
        if (this->_debugLog->getWriteDebugLog()) {
            ...
            if (is_array(value)) {
                ...
                for row in value {
                    if (is_array(row)) {
                        let returnMatrix[] = implode(pad,array_map([this, "_showValue"],row));
                        let rpad = "; ";
                    } else {
