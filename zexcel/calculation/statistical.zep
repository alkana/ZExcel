...
class Statistical
{
    ...
    private static function inverseNcdf(p)
    {
	    ...
	    let a = [
	        1: floatval("-3.969683028665376e+01"),
	        2: floatval("2.209460984245205e+02"),
	        3: floatval("-2.759285104469687e+02"),
	        4: floatval("1.383577518672690e+02"),
	        5: floatval("-3.066479806614716e+01"),
	        6: floatval("2.506628277459239e+00")
	    ];
	    let b = [
	        1: floatval("-5.447609879822406e+01"),
	        2: floatval("1.615858368580409e+02"),
	        3: floatval("-1.556989798598866e+02"),
	        4: floatval("6.680131188771972e+01"),
	        5: floatval("-1.328068155288572e+01")
	    ];
	    let c = [
	        1: floatval("-7.784894002430293e-03"),
	        2: floatval("-3.223964580411365e-01"),
	        3: floatval("-2.400758277161838e+00"),
	        4: floatval("-2.549732539343734e+00"),
	        5: floatval("4.374664141464968e+00"),
	        6: floatval("2.938163982698783e+00")
	    ];
	    let d = [
	        1: floatval("7.784695709041462e-03"),
	        2: floatval("3.224671290700398e-01"),
	        3: floatval("2.445134137142996e+00"),
	        4: floatval("3.754408661907416e+00")
	    ];
    ...
    private static function inverseNcdf3(p)
    {
        ...
        var a0 = 3.3871328727963666080,
            a1 = floatval("1.3314166789178437745E+2"),
            a2 = floatval("1.9715909503065514427E+3"),
            a3 = floatval("1.3731693765509461125E+4"),
            a4 = floatval("4.5921953931549871457E+4"),
            a5 = floatval("6.7265770927008700853E+4"),
            a6 = floatval("3.3430575583588128105E+4"),
            a7 = floatval("2.5090809287301226727E+3"),

            b1 = floatval("4.2313330701600911252E+1"),
            b2 = floatval("6.8718700749205790830E+2"),
            b3 = floatval("5.3941960214247511077E+3"),
            b4 = floatval("2.1213794301586595867E+4"),
            b5 = floatval("3.9307895800092710610E+4"),
            b6 = floatval("2.8729085735721942674E+4"),
            b7 = floatval("5.2264952788528545610E+3"),
        ...
        //    coefficients for p not close to 0, 0.5 or 1.
            ...
            c5 = floatval("2.41780725177450611770E-1"),
            c6 = floatval("2.27238449892691845833E-2"),
            c7 = floatval("7.74545014278341407640E-4"),

            d1 = 2.05319162663775882187,
            d2 = 1.67638483018380384940,
            d3 = floatval("6.89767334985100004550E-1"),
            d4 = floatval("1.48103976427480074590E-1"),
            d5 = floatval("1.51986665636164571966E-2"),
            d6 = floatval("5.47593808499534494600E-4"),
            d7 = floatval("1.05075007164441684324E-9"),

        //    coefficients for p near 0 or 1.
            e0 = 6.65790464350110377720,
            e1 = 5.46378491116411436990,
            e2 = 1.78482653991729133580,
            e3 = floatval("2.96560571828504891230E-1"),
            e4 = floatval("2.65321895265761230930E-2"),
            e5 = floatval("1.24266094738807843860E-3"),
            e6 = floatval("2.71155556874348757815E-5"),
            e7 = floatval("2.01033439929228813265E-7"),

            f1 = floatval("5.99832206555887937690E-1"),
            f2 = floatval("1.36929880922735805310E-1"),
            f3 = floatval("1.48753612908506148525E-2"),
            f4 = floatval("7.86869131145613259100E-4"),
            f5 = floatval("1.84631831751005468180E-5"),
            f6 = floatval("1.42151175831644588870E-7"),
            f7 = floatval("2.04426310338993978564E-15"),
            q, r, z;
    ...
    public static function critBinom(trials, probability, alpha)
    {
        ...
        if ((is_numeric(trials)) && (is_numeric(probability)) && (is_numeric(alpha))) {
            ...
            let EssentiallyZero = floatval("10e-12");
