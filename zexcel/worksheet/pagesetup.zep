...
class PageSetup
{
     ...
     */
    public function setPaperSize(int pValue = \ZExcel\Worksheet\PageSetup::PAPERSIZE_LETTER) -> <\ZExcel\Worksheet\PageSetup> {
        let this->_paperSize = pValue;
        return this;
    }
     ...
     * @return \ZExcel\Worksheet\PageSetup
     */
    public function setOrientation(string pValue = \ZExcel\Worksheet\PageSetup::ORIENTATION_DEFAULT) -> <\ZExcel\Worksheet\PageSetup> {
        let this->_orientation = pValue;
        return this;
    }
     ...
     */
    public function setScale(int pValue = 100, boolean pUpdate = true) -> <\ZExcel\Worksheet\PageSetup> {
        // Microsoft Office Excel 2007 only allows setting a scale between 10 and 400 via the user interface,
        // but it is apparently still able to handle any scale >= 0, where 0 results in 100
        if ((pValue >= 0) || is_null(pValue)) {
            let this->_scale = pValue;
            if (pUpdate) {
                let this->_fitToPage = false;
            }
        } else {
            throw new \ZExcel\Exception("Scale must not be negative");
        }
        return this;
    }
     ...
     * @return \ZExcel\Worksheet\PageSetup
     */
    public function setFitToPage(boolean pValue = true) -> <\ZExcel\Worksheet\PageSetup>  {
        let this->_fitToPage = pValue;
        return this;
    }
     ...
     * @return \ZExcel\Worksheet\PageSetup
     */
    public function setFitToHeight(pValue = 1, pUpdate = TRUE) -> <\ZExcel\Worksheet\PageSetup>  {
        let this->_fitToHeight = pValue;
        if (pUpdate) {
            let this->_fitToPage = TRUE;
        }
        return this;
    }
     ...
     * @return \ZExcel\Worksheet\PageSetup
     */
    public function setFitToWidth(pValue = 1, pUpdate = TRUE) -> <\ZExcel\Worksheet\PageSetup>  {
        let this->_fitToWidth = pValue;
        if (pUpdate) {
            let this->_fitToPage = TRUE;
        }
        return this;
     ...
     * @return boolean
     */
    public function isColumnsToRepeatAtLeftSet() -> boolean {
     ...
     * @return \ZExcel\Worksheet\PageSetup
     */
    public function setColumnsToRepeatAtLeft(pValue = null) -> <\ZExcel\Worksheet\PageSetup> {
        if (is_array(pValue)) {
            let this->_columnsToRepeatAtLeft = pValue;
        }
        return this;
    }
     ...
     * @return \ZExcel\Worksheet\PageSetup
     */
    public function setColumnsToRepeatAtLeftByStartAndEnd(pStart = "A", pEnd = "A") -> <\ZExcel\Worksheet\PageSetup> {
        let this->_columnsToRepeatAtLeft = [pStart, pEnd];
        return this;
    }
     ...
     * @return \ZExcel\Worksheet\PageSetup
     */
    public function setRowsToRepeatAtTop(array pValue = null) -> <\ZExcel\Worksheet\PageSetup>  {
        if (is_array(pValue)) {
            let this->_rowsToRepeatAtTop = pValue;
        }
        return this;
    }
     ...
     * @return \ZExcel\Worksheet\PageSetup
     */
    public function setRowsToRepeatAtTopByStartAndEnd(pStart = 1, pEnd = 1) -> <\ZExcel\Worksheet\PageSetup>  {
        let this->_rowsToRepeatAtTop = [pStart, pEnd];
        return this;
    }
     ...
     * @return \ZExcel\Worksheet\PageSetup
     */
    public function setHorizontalCentered(value = false) -> <\ZExcel\Worksheet\PageSetup>  {
        let this->_horizontalCentered = value;
        return this;
    }
     ...
     * @return \ZExcel\Worksheet\PageSetup
     */
    public function setVerticalCentered(value = false) -> <\ZExcel\Worksheet\PageSetup>  {
        let this->_verticalCentered = value;
        return this;
    }
    ...
    public function getPrintArea(index = 0) {
        ...
        if (isset(printAreas[index])) {
            return printAreas[index];
        }
        
        throw new \ZExcel\Exception("Requested Print Area does not exist");
    }
     ...
     * @return  \ZExcel\Worksheet\PageSetup
     */
    public function clearPrintArea(int index = 0) -> <\ZExcel\Worksheet\PageSetup>  {
        var printAreas;
        
        if (index == 0) {
            let this->_printArea = null;
        } else {
            let index = index - 1;
            let printAreas = explode(",", this->_printArea);
            
            if (isset(printAreas[index])) {
                unset(printAreas[index]);
    ...
    public function setPrintArea(value, index = 0, method = self::SETPRINTRANGE_OVERWRITE) {
        ...
        if (method == self::SETPRINTRANGE_OVERWRITE) {
            if (index == 0) {
                let this->_printArea = value;
            } else {
                let printAreas = explode(",", this->_printArea);
                if(index < 0) {
                    let index = count(printAreas) - abs(index) + 1;
                }
    ...
    {
        return this->setPrintArea(\ZExcel\Cell::stringFromColumnIndex(column1) . row1 . ":" . \ZExcel\Cell::stringFromColumnIndex(column2) . row2, index, method);
    }
    ...
    {
        return this->setPrintArea(\ZExcel\Cell::stringFromColumnIndex(column1) . row1 . ":" . \ZExcel\Cell::stringFromColumnIndex(column2) . row2, index, self::SETPRINTRANGE_INSERT);
    }
     ...
     */
    public function setFirstPageNumber(value = null) -> <\ZExcel\Worksheet\PageSetup>  {
        let this->_firstPageNumber = value;
        return this;
    }
