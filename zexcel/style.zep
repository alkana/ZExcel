...
class Style extends Style\Supervisor implements IComparable
{
    ...
    {
    	var pRange, rangeA, rangeB, rangeStart, rangeEnd, tmp;
        ...
        if (is_array(pStyles)) {
            if (this->isSupervisor) {
                ...
                if (pAdvanced && isset(pStyles["borders"])) {
                    ...
                    for x in range(1, xMax) {
                        ...
                        for y in range(1, yMax) {
                            ...
                            let range = colStart . rowStart . ":" . colEnd . rowEnd;
                ...
                for oldXfIndex, dummy in oldXfIndexes {
                ...
                switch (selectionType) {
                    ...
                    case "ROW":
                        for row in range(rangeStart[1], rangeEnd[1]) {
                            ...
                            let oldXfIndex = rowDimension->getXfIndex() === null ?
