...
class CodePage
{
     ...
     */
    public static function NumberToName(var codePage = 1252)
    {
        switch (codePage) {
            case 367:
                return "ASCII";    //    ASCII
            case 437:
                return "CP437";    //    OEM US
            case 720:
                throw new \ZExcel\Exception("Code page 720 not supported.");    //    OEM Arabic
            case 737:
            ...
            case 32768:
                return "MAC";      //    Apple Roman
            case 32769:
                throw new \ZExcel\Exception("Code page 32769 not supported.");  //    ANSI Latin I (BIFF2-BIFF3)
            case 65000:
        ...
        throw new \ZExcel\Exception("Unknown codepage: " . codePage);
    }
}
