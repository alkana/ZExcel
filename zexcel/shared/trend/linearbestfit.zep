 ...
 */
class LinearBestFit extends \ZExcel\Shared\Trend\BestFit
{
    /**
     ...
     * @param    boolean        const
     */
    public function __construct(var yValues, var xValues = [], constt = true)
    {
        if (parent::__construct(yValues, xValues) !== false) {
            this->linearRegression(yValues, xValues, constt);
        }
    }
    ...
    {
        return (double) this->getIntersect() + ((double) this->getSlope() * xValue);
    }
     ...
     * @param     boolean    const
     */
    private function linearRegression(yValues, xValues, constt)
    {
